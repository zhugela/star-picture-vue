...
export async function searchPictureByPictureUsingPost(
  ...
  return request<API.BaseResponseListPictureVO_>('/api/picture/search/picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponsePictureOutPaintingTask_>('/api/picture/out_painting/create_task', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.BaseResponsePictureOutPaintingTask_>('/api/picture/out_painting/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
